...
「模擬真實電商營運環境所開發的專案。除了基礎功能，核心專注於高併發的系統穩定性與搜尋效能優化，並透過 Docker 容器化部署與多層次資安防禦，實踐具備強度的後端架構設計。」
...
* **多級快取：** 實作 cache_page 與 Redis Mutex Lock，防止在極端流量下出現快取擊穿 ，確保資料庫僅承受必要的查詢壓力。
